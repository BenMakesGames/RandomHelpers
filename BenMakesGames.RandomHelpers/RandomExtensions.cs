...
public static class RandomExtensions
{
    extension(Random rng)
    {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T Next<T>(ReadOnlySpan<T> list)
        ...
        /// <returns></returns>
        public T Next<T>(IReadOnlySet<T> set)
        ...
        public T WeightedNext<T>(IReadOnlyList<T> list, Func<T, int> weightSelector)
        {
            var totalWeight = 0;
        ...
        public T WeightedNext<T>(IReadOnlyList<T> list, Func<T, long> weightSelector)
        {
            var totalWeight = 0L;
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="UnreachableException"></exception>
        public T WeightedNext<T>(IReadOnlySet<T> set, Func<T, int> weightSelector)
        {
            var totalWeight = 0;
        ...
        public T WeightedNext<T>(IReadOnlySet<T> set, Func<T, long> weightSelector)
        {
            var totalWeight = 0L;
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TKey NextKey<TKey, TValue>(IReadOnlyDictionary<TKey, TValue> dictionary)
        ...
        /// <returns></returns>
        public string NextString(ReadOnlySpan<char> allowedCharacters, int length)
        {
        ...
        /// <param name="length">The length of string to generate.</param>
        /// <returns></returns>
        public string NextString(List<char> allowedCharacters, int length)
        {
            var buffer = new char[length];
        ...
        public (double X, double Y) NextDoublePointInACircle(double radius = 1)
        {
        ...
        /// <param name="radius">Radius of the circle; defaults to 1.</param>
        /// <returns>A 2-tuple representing the X and Y coordinates.</returns>
        public (float X, float Y) NextSinglePointInACircle(float radius = 1)
        {
        ...
        /// <returns>A 2-tuple representing the X and Y coordinates.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public (float X, float Y) NextFloatPointInACircle(float radius = 1)
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T NextEnumValue<T>() where T: struct, Enum
        ...
        /// <returns></returns>
        public int NextPercentBonus(int baseAmount, float percentModifier)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double NextDouble(double exclusiveMax)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float NextSingle(float exclusiveMax)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float NextFloat(float exclusiveMax)
            => rng.NextSingle(exclusiveMax);
